...
export type Next_ArrivalsQuery = { __typename?: 'Query', next_arrivals: { __typename?: 'NextArrivalsResponse', message?: string | null, statusCode?: number | null, result?: { __typename?: 'NextArrivalsResult', stop?: { __typename?: 'StopNextArrivalsResponse', description: string, lat: string, lng: string, identificator: string } | null, line?: { __typename?: 'LineaNextArrivalsResponse', lineDescription: string } | null, data?: Array<{ __typename?: 'DataNextArrivalsResponse', line_description: string, flag_description: string, arrival: string, latitude: string, longitude: string, stop_latitude: string, stop_longitude: string, short_flag_description: string, flag_sign_description: string, is_adapted: string, car_identifier: string, driver_identifier: string, schedule_deviation: string, last_gps_date: string, error_message: string, stop_line_code: string, position: string }> | null } | null } };
